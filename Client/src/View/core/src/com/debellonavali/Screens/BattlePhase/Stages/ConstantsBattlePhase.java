...
public class ConstantsBattlePhase {
    ...
    // Dialog text
    public static final String DIALOG_TITLE = "Game ended";
    public static final String DIALOG_WIN_MESSAGE = "You won!";
    public static final String DIALOG_LOSE_MESSAGE = "You lost!";
